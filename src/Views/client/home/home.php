    ...
    <div class="row pos_home">
        <div class="col-lg-3 col-md-8 col-12">
            ...
            <div class="sidebar_widget catrgorie mb-35">
                <h3>Categories</h3>
                <ul>
                    <li class="has-sub"><a href="#"><i class="fa fa-caret-right"></i> shop</a>
                    ...
                    <li class="has-sub"><a href="#"><i class="fa fa-caret-right"></i> pages</a>
                        <!-- <ul class="categorie_sub">
                            <li><a href="#"><i class="fa fa-caret-right"></i> Accessories</a>
                                <ul class="categorie_sub">
                                    <li><a href="#"><i class="fa fa-caret-right"></i> Accessories</a></li>
                    ...
                    <li class="has-sub"><a href="#"><i class="fa fa-caret-right"></i> blog</a>
                        <!-- <ul class="categorie_sub">
                            <li><a href="#"><i class="fa fa-caret-right"></i> Accessories</a>
                                <ul class="categorie_sub">
                                    <li><a href="#"><i class="fa fa-caret-right"></i> Accessories</a></li>
                    ...
                    <li class="has-sub"><a href="#"><i class="fa fa-caret-right"></i> contact us </a>
                        <!-- <ul class="categorie_sub">
                            <li><a href="#"><i class="fa fa-caret-right"></i> Accessories</a>
                                <ul class="categorie_sub">
                                    <li><a href="#"><i class="fa fa-caret-right"></i> Accessories</a></li>
