                                ...
                                <form action="" method="post" enctype="multipart/form-data">
                                    ...
                                    <div class="card-block">
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-10">
                                                <input name="title" value="<?=$post['title'] ?>" type="text" class="form-control" placeholder="Nhập vào chủ đề" required>
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-4">
                                                <textarea name="content" id="" cols="40" rows="5"><?=$post['content'] ?></textarea>
                                            </div>
                                        </div>
